...
async function getAmazonPages() {
  const asin = "B0BDHX8Z63"; // famous iphone
  for (let i = 1; i <= 3; i++) {
    const url = `https://real-time-amazon-data.p.rapidapi.com/product-reviews?asin=${asin}&country=US&page=${i}&sort_by=MOST_RECENT`;
